...
void usage() {
    std::cout << "Usage: ./LEGEND [IP] [PORT] [DURATION] [THREADS] . Binary Made By: @LEGENDVIPOP\n";
    exit(1);
}
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Attack finished. Join: @LegendFreeDDoSAttack\n";
    return 0;
}
//g++ -std=c++14 LEGEND.cpp -o LEGEND -pthread